...
\begin{figure}[h]
\centering
\includegraphics[width=0.55\linewidth,height=0.40\textheight,keepaspectratio]{String_diagram.png}
\caption{\textbf{Stage 1 (cont.) --- compiled string diagram.} The commute model
as a Catlab wiring diagram: each variable becomes a mechanism box, copy dots
duplicate values feeding several mechanisms, and the shared latent root realises
the confounding $T\leftrightarrow Y$.}
\end{figure}
